#!/usr/bin/env bash
# Build the CPAP-PI dev-notes site from the Obsidian vault and push it
...
CONTENT_SUBDIR="200_Projects/KaMoamoa/CPAP-PI"
...
# CPAP-PI subfolder directly. We copy the notes plus *only the images they
...
echo "Published to https://xinyew.github.io/CPAP_PI_firmware/"
